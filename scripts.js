        ...
        function openWidget(character) {
          ...
          if (widgetID) {
            ...
            var width = window.innerWidth < 768 ? '100vw' : '75vw'; // adjust width based on screen size
            var height = window.innerHeight < 768 ? '80vh' : '80vh'; // adjust height based on screen size            
            widget.innerHTML =
